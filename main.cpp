...
int main() {
    ...
    cout << "//ajout d'un doc avec biblio.ajoutDoc(new Document (doc1));" << endl;
    biblio.ajoutDoc(new Document(doc1));
    cout << "//biblio.afficher(); :" << endl;
    biblio.afficher();
    cout << "\n" << endl;

    cout << "//On rajoute un Livre a biblio  biblio.ajoutDoc(new Livre(livre1)); " << endl;
    cout << "//biblio.afficher(); :" << endl;
    ...
    Livre livre1(titreLivre1, ptrResumeLivre1, "Kipling",
                 "phlammmarion", "2023");
    biblio.ajoutDoc(new Livre(livre1));
    biblio.afficher();

    cout << "//On rajoute un Article a biblio  biblio.ajoutDoc(new Article(article1)); " << endl;
    cout << "//biblio.afficher(); :" << endl;
    ...
    biblio.ajoutDoc(new Article(article1));
    biblio.afficher();

    cout<<"//test de biblio.rechercherDoc(""zrtpq"") :"<<endl;
    biblio.rechercheDoc("zrtpq");
